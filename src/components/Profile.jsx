...
function Profile() {
  ...
  const wordsToAnimate = ['Full-Stack Developer', 'Programmer', 'UI/UX Designer'];
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 max-w-7xl mx-auto" ref={contentRef}>
        ...
        <div className="text-center lg:text-left space-y-6 max-w-2xl">
          ...
          >
            Full-stack engineer focused on crafting fast, reliable web apps.
          </motion.p>
          ...
          >
            Currently studying Information and Communication Technology (Honours) at
          ...
          >
            ...
            {[
              ...
              >
                <Icon className="h-6 w-6 opacity-70 filter grayscale transition hover:opacity-100 hover:grayscale-0" />
              </motion.span>
            ))}
          </motion.div>
